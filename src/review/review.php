...
mysqli_select_db($link, "review_connection") or die(mysqli_error($link));
?>
                  ...
                  echo '<div>';
                    echo '<div class="d-flex justify-content-center">';
                      ...
                      echo '<div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded text-center">';
                        echo '<div class="row">';
                          echo '<div class="col">';
                            echo '<h5>'; echo $row["first_name"]; echo " ".$row["last_name"];  echo'</h5>';
                          echo '</div>';
                          
                          echo '<div class="col">';
                            echo '<h5 class="h6" id="Rating1">Rating:'; echo $row["review_rating"]; echo '</h5>';
                          echo '</div>';
                          echo'<div class="col">';
                           echo'<h6>Date:'; echo " ".$row["date"];echo '</h6>';
                          echo'</div>';
                        echo '</div>';
                        ...
                        echo'<div class="row">';
                          ...
                          echo'<div class="col">';
                            echo"<p class=\"fw-bold\">Review Title:"; echo" ".$row["review_title"]; echo"</p>";
                          echo'</div>';
                        echo'</div>';

                        echo'<div class="row">';
                          echo'<div class="col">';
                            echo'<p>'; echo $row["description"]; echo'</p>';
                          echo'</div>';
                        echo'</div>';
                      echo  '</div>';
                    echo '</div>';
