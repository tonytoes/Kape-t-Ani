const coffeeProducts = [
  ...
  [
    "Barako (Liberica) Bold Roast",
    "Iconic Filipino taste",
    "₱300",
    "matcha3.jpg",
  ],
  ...
  [
    "Mindoro Espresso Roast",
    "Rich crema espresso style",
    "₱330",
    "coffee8.jpg",
  ],
  [
    "Antique Caramel-Notes Arabica",
    "Sweet and buttery finish",
    "₱340",
    "matcha22.jpg",
  ],
];
          ...
          <div class="col-md-3 col-sm-6">
            <div class="card border-0 shadow-sm h-100">
              ...
              <div class="card-body text-center">
                ...
                <button id="addToCartBtn" class="btn btn-sm w-100 text-light" style="background-color:${color};">Add to Cart</button>
              </div>
            </div>
          </div>`
    )
