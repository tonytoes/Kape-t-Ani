                    ...
                    <tbody>
                      ...
                      <?php 
                        ...
                        while($row = mysqli_fetch_array($table)){
                          ...
                          $showAlert = false;
                          switch($condtion){
                              case '<=': $showAlert = ($quantity <= $ruleValue);
                                  break;
                              case '>=': $showAlert = ($quantity >= $ruleValue);
                                  break;    
                          }
                          ...
                          echo '<tr>';
                          echo   '<td>'; echo $ruleName; echo'</td>';
                          echo   '<td>'; echo $product; echo'</td>';
...
<div class="container my-5">
  <div class="row">
    <div class="col-12"> <h2 class="fw-bold text-brown mb-4">Inventory Alert</h2> </div>
    <div class="col"> <a id="alertButton" class="float-end"data-bs-toggle="modal" data-bs-target="#inventory_alert"><i class="fa-solid fa-triangle-exclamation"></i></a> </div>
  </div>
      ...
      <tbody>
        <?php 
          ...
          while($row = mysqli_fetch_array($table)){
            ...
            echo '<tr>';
            echo   '<td>'; echo $row['rule_name']; echo'</td>';
            echo   '<td>'; echo $row['product']; echo'</td>';
            echo   '<td>Quantity</td>';
            echo   '<td>'; echo $row['condition']; echo'</td>';
            echo   '<td>'; echo $row['rule_value']; echo'</td>';
            //enabled button
            if($row['enabled'] == 0){
