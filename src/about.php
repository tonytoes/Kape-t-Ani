  ...
  <section class="py-5">
    <div class="container text-center">
      ...
      <p class="mx-auto" style="max-width: 750px">
        Kape’t Ani was built on the vision of bringing the finest Filipino
        coffee and cultural crafts to every home. Our team is dedicated to
        supporting local farmers and artisans, combining tradition with modern
        e-commerce to make their creations more accessible globally.
      </p>
    </div>
  </section>
    ...
    <div class="container text-center">
      ...
      <div class="row justify-content-center mb-4 g-4">
        <div class="col-md-4 col-sm-6">
          <div class="team-card p-4 shadow rounded-4 bg-white">
            <img
              src="assets/images/BalungayMukha.png"
        ...
        <div class="col-md-4 col-sm-6">
          <div class="team-card p-4 shadow rounded-4 bg-white">
            <img
              src="assets/images/BugayongMukha.png"
              class="rounded-circle mb-3"
              style="width: 150px; height: 150px; object-fit: cover"
              alt="" />
        ...
        <div class="col-md-4 col-sm-6">
          <div class="team-card p-4 shadow rounded-4 bg-white">
            <img
              src="assets/images/CarlosMukha.png"
              class="rounded-circle mb-3"
              style="width: 150px; height: 150px; object-fit: cover"
              alt="" />
      ...
      <div class="row justify-content-center g-4">
        <div class="col-md-4 col-sm-6">
          <div class="team-card p-4 shadow rounded-4 bg-white">
            <img
              src="assets/images/ObedienteMukha.png"
              class="rounded-circle mb-3"
              style="width: 150px; height: 150px; object-fit: cover"
              alt="" />
        ...
        <div class="col-md-4 col-sm-6">
          <div class="team-card p-4 shadow rounded-4 bg-white">
            <img
              src="assets/images/UayanMukha.png"
              class="rounded-circle mb-3"
              style="width: 150px; height: 150px; object-fit: cover"
              alt="" />
